...
export const RECIPE_NEWEST_LIST_REQUEST = ' RECIPE_NEWEST_LIST_REQUEST';
export const  RECIPE_NEWEST_LIST_SUCCESS = ' RECIPE_NEWEST_LIST_SUCCESS';
export const  RECIPE_NEWEST_LIST_FAIL = ' RECIPE_NEWEST_LIST_FAIL';

export const RECIPE_POPULAR_LIST_REQUEST = 'RECIPE_POPULAR_LIST_REQUEST ';
export const  RECIPE_POPULAR_LIST_SUCCESS = ' RECIPE_POPULAR_LIST_SUCCESS';
export const  RECIPE_POPULAR_LIST_FAIL = ' RECIPE_POPULAR_LIST_FAIL';

export const RECIPE_LIST_BY_CATEGORY_REQUEST = 'RECIPE_LIST_BY_CATEGORY_REQUEST';
export const  RECIPE_LIST_BY_CATEGORY_SUCCESS = ' RECIPE_LIST_BY_CATEGORY_SUCCESS';
export const  RECIPE_LIST_BY_CATEGORY_FAIL = ' RECIPE_LIST_BY_CATEGORY_FAIL';

export const RECIPE_RATING_REQUEST = 'RECIPE_RATING_REQUEST';
export const  RECIPE_RATING_SUCCESS = ' RECIPE_RATING_SUCCESS';
export const  RECIPE_RATING_FAIL = ' RECIPE_RATING_FAIL';
